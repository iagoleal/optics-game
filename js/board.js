...
(function() {
  var Laser, LaserGun, Mirror, PlaneMirror, Star, Turnable, dist, dist2, _ref, _ref1, _ref2,
  ...
  LaserGun = (function(_super) {
    ...
    function LaserGun() {
      _ref2 = LaserGun.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
  ...
  Laser = (function() {
    ...
    Laser.prototype.angle = function(point) {
      ...
      _ref3 = this.changeRate(point), dy = _ref3[0], dx = _ref3[1];
